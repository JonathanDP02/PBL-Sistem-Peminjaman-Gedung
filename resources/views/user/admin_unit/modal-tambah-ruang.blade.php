<div id="modalTambahRuang" class="hidden fixed inset-0 z-[99] flex items-center justify-center bg-black/60 backdrop-blur-sm transition-opacity duration-300 opacity-0">
    ...
    <div class="bg-white dark:bg-[#151515] border border-slate-200 dark:border-[#2A2A2A] rounded-3xl w-full max-w-3xl p-8 relative shadow-2xl transform scale-95 transition-transform duration-300">
        ...
        <form action="/admin_unit/rooms" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="flex flex-col justify-between">
                    <div>
                        ...
                        <div id="container-fasilitas-tambah" class="space-y-3 max-h-[220px] overflow-y-auto pr-2 custom-scrollbar">
