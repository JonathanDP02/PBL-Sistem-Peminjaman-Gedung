...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --glow-opacity-before: 0.25;
            --glow-opacity-after: 0.2;
        }
        ...
        .dark {
            ...
            --glow-opacity-before: 0.15;
            --glow-opacity-after: 0.1;
        }
        ...
        body::before { background: #14B8A6; top: -5%; left: -10%; opacity: var(--glow-opacity-before);}
        body::after { background: #0DBAF9; bottom: 10%; right: -10%; animation-duration: 15s; animation-delay: -3s; opacity: var(--glow-opacity-after);}
        ...
        .card-title { color: var(--text-main); font-size: 1.2rem; font-weight: 600; margin: 0; text-align: center; }
        .card svg { width: 80px; height: 80px; }
        
        .calendar-wrapper {
            background-color: var(--bg-calendar); border: 1px solid var(--border-color);
            border-radius: 16px; width: 100%; box-shadow: 0 0 40px rgba(0,0,0,0.15); overflow-x: auto; 
        ...
        .calendar-grid > div { border-bottom: 1px solid var(--border-color); border-right: 1px solid var(--border-color); padding: 16px; transition: border-color 0.3s ease; }
        ...
        .col-header.dim span { color: var(--text-dim); opacity: 0.5; }
        ...
        .weekend-bg { background-color: rgba(0,0,0,0.01); }
        .dark .weekend-bg { background-color: rgba(255,255,255,0.02); }
        ...
        .slot.tersedia { border: 1px solid rgba(20, 184, 166, 0.4); background-color: rgba(20, 184, 166, 0.08); }
        .slot.tersedia .slot-header { color: #14B8A6; }
        
        .slot.terisi { border: 1px solid rgba(239, 68, 68, 0.4); background-color: rgba(239, 68, 68, 0.08); }
