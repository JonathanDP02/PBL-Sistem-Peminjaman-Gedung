        ...
        <div class="w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center z-10 scale-95 md:scale-100 origin-center">
            ...
            <div class="order-1 flex flex-col justify-center gap-2">
                ...
                <div class="hidden sm:flex items-center gap-4 mt-4 lg:mt-8 pt-4 lg:pt-8 border-t border-slate-200 dark:border-white/5">
                    ...
                    <div>
                        <div class="text-sm font-semibold text-slate-900 dark:text-white">Akses Eksklusif Kampus</div>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-4 lg:space-y-5">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <label for="remember_me" class="inline-flex items-center gap-2 cursor-pointer group">
                                <input id="remember_me" type="checkbox" class="w-4 h-4 rounded border-slate-300 dark:border-gray-600 text-[#14B8A6] shadow-sm focus:ring-[#14B8A6]/50 focus:ring-offset-0 bg-slate-900 dark:bg-[#0a0a0a]" name="remember">
                                <span class="text-xs lg:text-sm font-medium text-slate-500 dark:text-slate-400 group-hover:text-slate-700 dark:group-hover:text-slate-300 transition">Ingat Saya</span>
                            </label>
