        ...
        <div class="w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center z-10 scale-95 md:scale-100 origin-center">
            ...
            <div class="order-1 flex flex-col justify-center gap-2">
                ...
                <div class="hidden sm:flex items-center gap-4 mt-4 lg:mt-8 pt-4 lg:pt-8 border-t border-slate-200 dark:border-white/5">
                    ...
                    <div>
                        <div class="text-sm font-semibold text-slate-900 dark:text-white">Pemulihan Password Aman</div>
            ...
            <div class="order-2 w-full max-w-md mx-auto lg:ml-auto lg:mr-0 z-10">
                ...
                <div class="bg-white dark:bg-[#111] border border-slate-200 dark:border-white/5 hover:border-[#14B8A6]/20 transition rounded-3xl p-6 sm:p-8 lg:p-10 shadow-[0_0_50px_rgba(0,0,0,0.05)] dark:shadow-[0_0_50px_rgba(0,0,0,0.4)] backdrop-blur-sm">
                    <div class="text-left mb-6 lg:mb-8 flex flex-col">
                        ...
                        <p class="text-xs lg:text-sm text-slate-500 dark:text-slate-400">Kami akan mengirimkan link reset ke email Anda.</p>
                    </div>
